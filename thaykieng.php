...
?>
   ...
   ?>
    ...
    <p style="background-color:	#EEE0E5;">🚴Trang chủ  » Thay kính</p>
    <p style="text-align:center;  background-color:#BBBBBB; font-size:40px; margin-top:-20px; font-family:'Comic Sans MS'; ">Thay kính</p>   
    ...
    <img style="width:100%;" src="images/thaypin.jpg" alt="">
              <div class="col-dau" style="width:100%; height:350px; background-color:#d9d9d9; padding:15px;">
                  <h5>LL DESIGN.com – ĐỊA ĐIỂM THAY KIẾNG ĐỒNG HỒ UY TÍN HÀNG ĐẦU</h5>
                  <p>&rsaquo; Kính đồng hồ đạt tiêu chuẩn chính hãng, cam kết thời gian sử dụng.<br>
                  &rsaquo; Quy trình 8 bước mặt kiếng đồng hồ đạt tiêu chuẩn quốc tế.<br>
                  &rsaquo; Thời gian mặt kính chỉ trong vòng 15 phút.<br>
                  &rsaquo; Thay mặt kính bảo hành 12 tháng với đồng hồ thường.<br>
                  &rsaquo; Kiểm tra chống nước trực tiếp trước mặt khách khi trao trả đồng hồ.</p>
...
chuyên môn cao.</p>
              ...
              <div class="cacbuoc" style="height:1250px; ">
                <h4 style="text-align:center;">THAY KÍNH ĐỒNG HỒ – 8 BƯỚC ĐẠT CHUẨN QUỐC TẾ</h4>
                <div class="card" style="width: 18rem;">
  <img class="card-img-top" src="images/thaypin1.png" alt="Card image cap">
  <div class="card-body">
    <p class="card-text">Bước 1: Tiếp nhận, kiểm tra và đánh giá mức độ hư hại của đồng hồ.</p>
  </div>
</div>
<div class="card" style="width: 18rem;">
  <img class="card-img-top" src="images/thaypin2.png" alt="Card image cap">
  <div class="card-body">
    <p class="card-text">Bước 2: Tháo chốt dây và mở nắp đáy đồng hồ.</p>
  </div>
</div>
<div class="card" style="width: 18rem;">
  <img class="card-img-top" src="images/thaykinh3.png" alt="Card image cap">
  <div class="card-body">
    <p class="card-text">Bước 3: Tháo chốt chỉnh giờ và bộ máy ra khỏi vỏ.</p>
  </div>
</div>
<div class="card" style="width: 18rem;">
  <img class="card-img-top" src="images/thaykinh4.png" alt="Card image cap">
  <div class="card-body">
    <p class="card-text">Bước 4: Lấy số đo mặt kính đồng hồ.</p>
  </div>
</div>
<div class="card" style="width: 18rem;">
  <img class="card-img-top" src="images/thaykinh5.png" alt="Card image cap">
  <div class="card-body">
    <p class="card-text">Bước 5: Loại bỏ kính cũ và ép kính mới.</p>
  </div>
</div>
<div class="card" style="width: 18rem;">
  <img class="card-img-top" src="images/thaykinh6.png" alt="Card image cap">
  <div class="card-body">
    <p class="card-text">Bước 6: Lắp máy vào vỏ, kiểm tra các chi tiết và gioăng chống nước.</p>
  </div>
</div>
<div class="card" style="width: 18rem;">
  <img class="card-img-top" src="images/thaykinh7.png" alt="Card image cap">
  <div class="card-body">
    <p class="card-text">Bước 7: Kiểm tra độ kín nước bằng máy chuyên dụng.</p>
  </div>
</div>
<div class="card" style="width: 18rem;">
  <img class="card-img-top" src="images/thaykinh8.png" alt="Card image cap">
  <div class="card-body">
    <p class="card-text">Bước 8: Kiểm tra độ hoàn thiện mặt kính, độ ổn định và căn chỉnh lại đồng hồ..</p>
  </div>
</div>
