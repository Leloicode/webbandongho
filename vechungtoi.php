...
?>
   ...
   ?>
    ...
    <p style="background-color:	#EEE0E5;">🚴Trang chủ  » Về chúng tôi</p>
    <p style="text-align:center;  background-color:#BBBBBB; font-size:40px; margin-top:-20px; font-family:'Comic Sans MS'; ">VỀ CHÚNG TÔI</p>   
         
    <div class="container">
      
    <div class="col-dau">
       <h4 style="font-family:'Comic Sans MS';border-left:5px solid;">&nbsp;Mục đích của LL DESIGN</h4>         
       <p>Mục đích của chúng tôi là nâng cao chất lượng cuộc sống và góp phần vào một tương lai khỏe mạnh hơn. Chúng tôi mong muốn tạo ra một thế giới tốt đẹp và khỏe mạnh hơn. Chúng tôi cũng mong muốn truyền cảm hứng cho mọi người sống lành mạnh hơn. Đây là cách chúng tôi đóng góp cho xã hội trong khi vẫn đảm bảo sự thành công lâu dài trong kinh doanh của LL SHOP.</p>         
       <img style="width:49%; height:50%;" src="images/banerdau.jpg" alt="">
       <img style="height:850px; height:50%;width:49%;" src="images/banerdau2.jpg" alt=""> 
       <br>
       <br>
       <h4 style="font-family:'Comic Sans MS';border-left:5px solid;">&nbsp;Tham vọng của LL DESIGN</h4>
       <p>LL DESIGN đã xác định ba tham vọng tổng thể cho năm 2030 sẽ dẫn dắt hoạt động để giúp cho thế giới có một cuộc sống lành mạnh ,trẻ trung,năng động.</p>    
              
    </div>
    <div class="col-giua">
    <h4 style="font-family:'Comic Sans MS'; border-left:5px solid;">&nbsp;Sự giúp đỡ</h4>
      <div class="col-left1" style="color:#1C9CC8;margin-top:30px; width:35%; height:230px; float:left;padding:15px; ">
        <h5 style="font-family: "NestleTextTFVN-Bold" ; "  > 	► CHO CÁ NHÂN & GIA ĐÌNH</h5>
        <span class="text-blue-dark">Giúp đỡ</span><br>
        <span class="verybigfont text-blue" style="font-size:50px;">50 triệu</span>
        <p>giới trẻ có cuộc sống lành mạnh hơn</p>
      </div>
      <div class="col-left1" style="color:#73A039; margin-top:30px; width:30%;height:50%; height:230px; padding:15px; float:right;">
        <h5 style="font-family: "NestleTextTFVN-Bold" ; " > 	► CHO HÀNH TINH</h5>
        <span class="text-blue-dark">thời gian</span><br>
        <span class="verybigfont text-blue" style="font-size:50px;">Hợp lí</span>
        <p>cho mọi người</p>
      </div>
      <div class="col-left1" style="color:#FB6035;margin-top:30px; width:30%; float:right; height:230px; margin-right:35px; padding:15px;  ">
        <h5 style="font-family: "NestleTextTFVN-Bold" ; " > 	► CHO CỘNG ĐỒNG</h5>
        <span class="text-blue-dark">Giúp cải thiện cuộc sống của</span><br>
        <span class="verybigfont text-blue" style="font-size:50px;">30 triệu</span>
        <p>người sắp xếp được thời gian hợp lí</p>
      </div>

    </div>
    <div class="col-cuoi" style="margin-top:50px;">
      <h4 style="margin-top:300px;border-left:5px solid;">&nbsp;Giá trị của LL DESIGN</h4>
      <p>Chúng tôi mong muốn tạo ra một thế giới tốt đẹp và khỏe mạnh hơn. Đó cũng là cách LL DESIGN khởi đầu từ cách đây hơn 150 năm khi ông leloi LL SHOP đưa ra thị trường những mẫu đồng hồ đẹp nhất.</p>
      
      <div class="baner-cuoi" style="height:900px;">
      <br>
      
      <div class="card" style="width: 49.5%; float:left; height:760px;">
      <img class="card-img-top" src="images/banercuoi1.jpg" alt="Card image cap">
      <div class="card-body">
        <h4>Kể từ năm 2020...</h4>
        <p class="card-text">Chúng tôi đã tạo ra những sản phẩm giúp nâng cao chất lượng cuộc sống và góp phần vào một tương lai tươi đẹp hơn.</p>
      </div>
      
    </div>
    <div class="card" style="width: 49.5%; float:right;">
      <img class="card-img-top" src="images/banercuoi2.jpg" alt="Card image cap">
      <div class="card-body">
        <h5>Nguyên tắc kinh doanh của LL DESIGN</h5>
        <p class="card-text">Giá trị của chúng tôi được phản ánh trong cách chúng tôi hoạt động kinh doanh, luôn luôn hành động hợp pháp và trung thực với sự tôn trọng đối với chính nhân viên và đối tác của LL DESIGN..</p>
      </div>
