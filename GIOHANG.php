...
<header>
   ...
   ?>
    ...
    <p style="background-color:	#EEE0E5;">🚴Trang chủ  » giỏ hàng của tôi</p>
    <header >
      <?php 
      $conn1=mysqli_connect('localhost','root','','doanwebchinhthuc') or die ('Kết nối database thất bại!');
      $sql1="SELECT * FROM `giohang` WHERE TAIKHOAN='$ten'";
      ...
      if ($dem <= 0) {
        ?>
        <div class="khongcosanpham" style="background:	#DCDCDC; height:500px; text-align: center; "><?php echo "Giỏ Hàng của bạn hiện tại trống."?></div>
        <?php
      }
      else {
      ?>
      
      <h3 style="text-align: center;margin-top:-20px; background-color:#BEBEBE;">GIỎ HÀNG CỦA TÔI</h3>
     <form action="" method="post"  >
     <table  class="table" >
                    ...
                    <th width="5px"><?php $stt++; echo $stt; ?></th>
                        ...
                        <td style="padding:15px;"><?php echo $row['GIA'].".000 đ";?></td>
                        <td style="padding:15px;"><?php echo $row['SOLUONG']; ?></td>
                        
                        <td style="padding:15px;"><?php $thanhtien=$row['SOLUONG'] * $row['GIA']; echo $thanhtien.".000 đ"?></td>
                        
                        <td style="padding:15px;"><button class="btn btn-light"><a style="color:black; text-decoration: none;" href="suasoluong.php?masp=<?php echo $row['MASP']; ?>"> Sửa  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-brush-fill" viewBox="0 0 16 16">
  <path d="M15.825.12a.5.5 0 0 1 .132.584c-1.53 3.43-4.743 8.17-7.095 10.64a6.067 6.067 0 0 1-2.373 1.534c-.018.227-.06.538-.16.868-.201.659-.667 1.479-1.708 1.74a8.118 8.118 0 0 1-3.078.132 3.659 3.659 0 0 1-.562-.135 1.382 1.382 0 0 1-.466-.247.714.714 0 0 1-.204-.288.622.622 0 0 1 .004-.443c.095-.245.316-.38.461-.452.394-.197.625-.453.867-.826.095-.144.184-.297.287-.472l.117-.198c.151-.255.326-.54.546-.848.528-.739 1.201-.925 1.746-.896.126.007.243.025.348.048.062-.172.142-.38.238-.608.261-.619.658-1.419 1.187-2.069 2.176-2.67 6.18-6.206 9.117-8.104a.5.5 0 0 1 .596.04z"/>
</svg></a></button ><button class="btn btn-light"><a   style="color:black; text-decoration: none;" href="deletegiohang.php?masp=<?php echo $row['MASP']; ?>"> Xóa <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x" viewBox="0 0 16 16">
  <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/>
                ...
                ?>
                <tr style="text-align: center;">
                  <td><button class="btn btn-info"><a style="text-decoration: none; color:black;" href="CUAHANG.php">Tiếp tục mua hàng</a> </button></td>
                  <td></td>
                  <td></td>
                  <td></td>
                  <td></td>
                  <th>Tổng: <?php echo $tong.".000 đ" ?> </th>
                  <td><button class="btn btn-warning"><a style="text-decoration: none; color:black;" href="MUANGAY.php?thanhtoan=1">Thanh toán</a></button></td>
                </tr>
                </table>
     </form>
     <?php
