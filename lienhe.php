...
?>
   ...
   ?>
    ...
    <p style="background-color:	#EEE0E5;">🚴Trang chủ  » Liên hệ</p>
    <p style="text-align:center;  background-color:#BBBBBB; font-size:40px; margin-top:-20px; font-family:'Comic Sans MS'; ">Liên hệ</p>   
         
    <div class="container">
      
    <img width="100%" height="500px" src="images/banerto.jpg" alt="">
    <p style="margin-top:20px;font-family:'Comic Sans MS';"> 	►  LL DESIGN.com được thành lập từ năm 2021, với mục tiêu trở thành một trong những nhà bán lẻ sản phẩm đồng hồ CHÍNH HÃNG phổ biến nhất tại Việt Nam. Với hơn 14 năm không ngừng nỗ lực và phát triển, chúng tôi mong muốn mang lại cho khách hàng những sản phẩm hoàn hảo, với chính sách giá tốt nhất và những dịch vụ đi kèm đầy đủ.</p>
    
    <hr><div class="col-cuoi" style="margin-top:50px;">
      
      <h5 style="border-left:5px solid;">&nbsp;DANH SÁCH CỬA HÀNG</h5>
...
<hr>
    ...
    <div class="card" style="width: 49.5%; float:right; height:930px;">
