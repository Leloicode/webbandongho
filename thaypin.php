...
?>
   ...
   ?>
    ...
    <p style="background-color:	#EEE0E5;">🚴Trang chủ  » Thay pin</p>
    <p style="text-align:center;  background-color:#BBBBBB; font-size:40px; margin-top:-20px; font-family:'Comic Sans MS'; ">Thay pin</p>   
    ...
    <img style="width:100%;" src="images/thaypin.jpg" alt="">
              <div class="col-dau" style="width:100%; height:350px; background-color:#d9d9d9; padding:15px;">
                  <h5>LL DESIGN.com – ĐỊA ĐIỂM THAY PIN ĐỒNG HỒ UY TÍN HÀNG ĐẦU</h5>
                  <p>&rsaquo; Pin đồng hồ đạt tiêu chuẩn chính hãng, cam kết thời gian sử dụng.<br>
                  &rsaquo; Quy trình 8 bước thay pin đồng hồ đạt tiêu chuẩn quốc tế.<br>
                  &rsaquo; Thời gian thay pin chỉ trong vòng 15 phút.<br>
                  &rsaquo; Thay pin bảo hành 12 tháng với đồng hồ thường.<br>
                  &rsaquo; Hỗ trợ kiểm tra độ chống nước bằng máy chuyên dụng.</p>
<h5>Tất cả các quy trình và dịch vụ được thực hiện và đảm bảo bởi:</h5>
<p>&rsaquo; Trang thiết bị hiện đại tiên tiến đạt tiêu chuẩn quốc tế
<br>&rsaquo; Đội ngũ kỹ thuật viên được đào tạo bài bản, chuyên nghiệp và có kinh nghiệm
chuyên môn cao.</p>
              </div>
              <br>
              <div class="cacbuoc" style="height:1250px; ">
                <h4 style="text-align:center;">Thay Pin Đồng Hồ - 7 Bước Đạt Chuẩn Thụy Sĩ</h4>
                <div class="card" style="width: 18rem;">
  <img class="card-img-top" src="images/thaypin1.png" alt="Card image cap">
  <div class="card-body">
    <p class="card-text">Bước 1: Tiếp nhận, thẩm định và tư vấn thay pin chính hãng cho đồng hồ.</p>
  </div>
</div>
<div class="card" style="width: 18rem;">
  <img class="card-img-top" src="images/thaypin2.png" alt="Card image cap">
  <div class="card-body">
    <p class="card-text">Bước 2: Mở nắp đáy bằng dụng cụ phù hợp (tùy theo thiết kế).</p>
  </div>
</div>
<div class="card" style="width: 18rem;">
  <img class="card-img-top" src="images/thaypin3.png" alt="Card image cap">
  <div class="card-body">
    <p class="card-text">Bước 3: Kiểm tra, làm sạch bụi bên trong đồng hồ.</p>
  </div>
</div>
<div class="card" style="width: 18rem;">
  <img class="card-img-top" src="images/thaypin4.png" alt="Card image cap">
  <div class="card-body">
    <p class="card-text">Bước 4: Chọn loại pin phù hợp cho từng loại máy.</p>
  </div>
</div>
<div class="card" style="width: 18rem;">
  <img class="card-img-top" src="images/thaypin5.png" alt="Card image cap">
  <div class="card-body">
    <p class="card-text">Bước 5: Thay pin và kiểm tra lần 1 hoạt động của đồng hồ.</p>
  </div>
</div>
<div class="card" style="width: 18rem;">
  <img class="card-img-top" src="images/thaypin6.png" alt="Card image cap">
  <div class="card-body">
    <p class="card-text">Bước 6: Kiểm tra và thay thế giăng nắp đáy nếu cần, đảm bảo độ kín.</p>
  </div>
</div>
<div class="card" style="width: 18rem;">
  <img class="card-img-top" src="images/thaypin1.png" alt="Card image cap">
  <div class="card-body">
    <p class="card-text">Bước 7: Kiểm tra độ ổn định và hoàn thiện, canh chỉnh lại thời gian.</p>
  </div>
</div>
...
<hr>
<br>
<h4 style="text-align:center; border-bottom:1px solid;">Bảng giá theo dịch vụ và sửa chữa đồng hồ.</h4>
<br>
...
<td style="text-align: left;">
<h4>Thay kính thường</h4>
</td>
<td style="text-align: right;">
<h4>150.000đ – 200.000đ</h4>
</td>
</tr>
<tr>
<td style="text-align: left;">
<h4>Thay kính Sapphire</h4>
</td>
<td style="text-align: right;">
<h4>300.000đ – 900.000đ</h4>
</td>
</tr>
<tr>
<td style="text-align: left;" rowspan="8">
<h4>Thay các phụ kiện khác</h4>
</td>
<td style="text-align: left;">
<h4>Thay Nhông</h4>
</td>
<td style="text-align: right;">
<h4>200.000đ – 900.000đ</h4>
</td>
</tr>
<tr>
<td style="text-align: left;">
...
<td style="text-align: left;">
<h4>Lau Dầu đồng hồ pin</h4>
</td>
<td style="text-align: right;">
<h4>150.000đ – 300.000đ</h4>
</td>
</tr>
<tr>
<td style="text-align: left;">
<h4>Lau dầu đồng hồ cơ</h4>
</td>
<td style="text-align: right;">
<h4>300.000đ – 500.000đ</h4>
</td>
</tr>
<tr>
<td style="text-align: left;">
...
<hr>
<br>
<h5 style="border-left:5px solid;">&nbsp;DANH SÁCH LIÊN HỆ CỬA HÀNG </h5>
      ...
      <div class="card-body">
      <button type="button" class="btn btn-light" style=" width:500px;">ĐÀ NẴNG</button><br>
            <b>ROOM 1:</b><br>
        ...
        </svg><p> &nbsp; Địa chỉ: 99 Tô Hiến Thành ,TP Đà Nẵng.</p>
...
</svg><p style="margin-top:-12px;"> &nbsp; Số điện thoại: <a href="tel:0357805837">0357805837</a></p>
...
</svg><p style="margin-top:-15px;">&nbsp; Giờ làm việc:8h-19h</p>
    <hr>
    <b>ROOM 2:</b><br>
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" style="float:left; margin-top:8px;" fill="currentColor" class="bi bi-geo-alt-fill" viewBox="0 0 16 16">
        <path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10zm0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6z"/>
        </svg><p> &nbsp; Địa chỉ: 29 Hồ Xuân Hương ,TP Đà nẵng.</p>
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" style="float:left; margin-top:-5px;" fill="currentColor" class="bi bi-telephone-fill" viewBox="0 0 16 16">
  <path fill-rule="evenodd" d="M1.885.511a1.745 1.745 0 0 1 2.61.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.678.678 0 0 0 .178.643l2.457 2.457a.678.678 0 0 0 .644.178l2.189-.547a1.745 1.745 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.634 18.634 0 0 1-7.01-4.42 18.634 18.634 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877L1.885.511z"/>
</svg><p style="margin-top:-12px;"> &nbsp; Số điện thoại: <a href="tel:0357805837">0314465178</a></p>
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" style="float:left; margin-top:-5px;" fill="currentColor" class="bi bi-alarm-fill" viewBox="0 0 16 16">
  <path d="M6 .5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 0 1H9v1.07a7.001 7.001 0 0 1 3.274 12.474l.601.602a.5.5 0 0 1-.707.708l-.746-.746A6.97 6.97 0 0 1 8 16a6.97 6.97 0 0 1-3.422-.892l-.746.746a.5.5 0 0 1-.707-.708l.602-.602A7.001 7.001 0 0 1 7 2.07V1h-.5A.5.5 0 0 1 6 .5zm2.5 5a.5.5 0 0 0-1 0v3.362l-1.429 2.38a.5.5 0 1 0 .858.515l1.5-2.5A.5.5 0 0 0 8.5 9V5.5zM.86 5.387A2.5 2.5 0 1 1 4.387 1.86 8.035 8.035 0 0 0 .86 5.387zM11.613 1.86a2.5 2.5 0 1 1 3.527 3.527 8.035 8.035 0 0 0-3.527-3.527z"/>
</svg><p style="margin-top:-15px;">&nbsp; Giờ làm việc:7h30-19h</p>
<hr>
<b>ROOM 3:</b><br>
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" style="float:left; margin-top:8px;" fill="currentColor" class="bi bi-geo-alt-fill" viewBox="0 0 16 16">
        <path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10zm0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6z"/>
        </svg><p> &nbsp; Địa chỉ: 21 Liên Chiểu ,TP Đà nẵng.</p>
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" style="float:left; margin-top:-5px;" fill="currentColor" class="bi bi-telephone-fill" viewBox="0 0 16 16">
  <path fill-rule="evenodd" d="M1.885.511a1.745 1.745 0 0 1 2.61.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.678.678 0 0 0 .178.643l2.457 2.457a.678.678 0 0 0 .644.178l2.189-.547a1.745 1.745 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.634 18.634 0 0 1-7.01-4.42 18.634 18.634 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877L1.885.511z"/>
</svg><p style="margin-top:-12px;"> &nbsp; Số điện thoại: <a href="tel:0357805837">0315751649</a></p>
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" style="float:left; margin-top:-5px;" fill="currentColor" class="bi bi-alarm-fill" viewBox="0 0 16 16">
  <path d="M6 .5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 0 1H9v1.07a7.001 7.001 0 0 1 3.274 12.474l.601.602a.5.5 0 0 1-.707.708l-.746-.746A6.97 6.97 0 0 1 8 16a6.97 6.97 0 0 1-3.422-.892l-.746.746a.5.5 0 0 1-.707-.708l.602-.602A7.001 7.001 0 0 1 7 2.07V1h-.5A.5.5 0 0 1 6 .5zm2.5 5a.5.5 0 0 0-1 0v3.362l-1.429 2.38a.5.5 0 1 0 .858.515l1.5-2.5A.5.5 0 0 0 8.5 9V5.5zM.86 5.387A2.5 2.5 0 1 1 4.387 1.86 8.035 8.035 0 0 0 .86 5.387zM11.613 1.86a2.5 2.5 0 1 1 3.527 3.527 8.035 8.035 0 0 0-3.527-3.527z"/>
</svg><p style="margin-top:-15px;">&nbsp; Giờ làm việc:7h30-19h</p>
<hr>
    ...
    <div class="card" style="width: 48.5%; float:right; height:930px;">
      ...
      <div class="card-body">
      <button type="button" class="btn btn-light" style=" width:500px;">HỒ CHÍ MINH</button><br>
            <b>ROOM 1:</b><br>
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" style="float:left; margin-top:8px;" fill="currentColor" class="bi bi-geo-alt-fill" viewBox="0 0 16 16">
        <path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10zm0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6z"/>
        </svg><p> &nbsp; Địa chỉ: phường 28, Bình Thạnh, Tp HCM.</p>
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" style="float:left; margin-top:-5px;" fill="currentColor" class="bi bi-telephone-fill" viewBox="0 0 16 16">
  <path fill-rule="evenodd" d="M1.885.511a1.745 1.745 0 0 1 2.61.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.678.678 0 0 0 .178.643l2.457 2.457a.678.678 0 0 0 .644.178l2.189-.547a1.745 1.745 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.634 18.634 0 0 1-7.01-4.42 18.634 18.634 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877L1.885.511z"/>
</svg><p style="margin-top:-12px;"> &nbsp; Số điện thoại: <a href="tel:0521463584">0521463584</a></p>
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" style="float:left; margin-top:-5px;" fill="currentColor" class="bi bi-alarm-fill" viewBox="0 0 16 16">
  <path d="M6 .5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 0 1H9v1.07a7.001 7.001 0 0 1 3.274 12.474l.601.602a.5.5 0 0 1-.707.708l-.746-.746A6.97 6.97 0 0 1 8 16a6.97 6.97 0 0 1-3.422-.892l-.746.746a.5.5 0 0 1-.707-.708l.602-.602A7.001 7.001 0 0 1 7 2.07V1h-.5A.5.5 0 0 1 6 .5zm2.5 5a.5.5 0 0 0-1 0v3.362l-1.429 2.38a.5.5 0 1 0 .858.515l1.5-2.5A.5.5 0 0 0 8.5 9V5.5zM.86 5.387A2.5 2.5 0 1 1 4.387 1.86 8.035 8.035 0 0 0 .86 5.387zM11.613 1.86a2.5 2.5 0 1 1 3.527 3.527 8.035 8.035 0 0 0-3.527-3.527z"/>
</svg><p style="margin-top:-15px;">&nbsp; Giờ làm việc:8h-19h</p>
    <hr>
    <b>ROOM 2:</b><br>
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" style="float:left; margin-top:8px;" fill="currentColor" class="bi bi-geo-alt-fill" viewBox="0 0 16 16">
        <path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10zm0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6z"/>
        </svg><p> &nbsp; Địa chỉ: Hẻm 480,phường 28, Bình Thạnh, Tp HCM.</p>
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" style="float:left; margin-top:-5px;" fill="currentColor" class="bi bi-telephone-fill" viewBox="0 0 16 16">
  <path fill-rule="evenodd" d="M1.885.511a1.745 1.745 0 0 1 2.61.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.678.678 0 0 0 .178.643l2.457 2.457a.678.678 0 0 0 .644.178l2.189-.547a1.745 1.745 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.634 18.634 0 0 1-7.01-4.42 18.634 18.634 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877L1.885.511z"/>
</svg><p style="margin-top:-12px;"> &nbsp; Số điện thoại: <a href="tel:0984724315">0984724315</a></p>
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" style="float:left; margin-top:-5px;" fill="currentColor" class="bi bi-alarm-fill" viewBox="0 0 16 16">
  <path d="M6 .5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 0 1H9v1.07a7.001 7.001 0 0 1 3.274 12.474l.601.602a.5.5 0 0 1-.707.708l-.746-.746A6.97 6.97 0 0 1 8 16a6.97 6.97 0 0 1-3.422-.892l-.746.746a.5.5 0 0 1-.707-.708l.602-.602A7.001 7.001 0 0 1 7 2.07V1h-.5A.5.5 0 0 1 6 .5zm2.5 5a.5.5 0 0 0-1 0v3.362l-1.429 2.38a.5.5 0 1 0 .858.515l1.5-2.5A.5.5 0 0 0 8.5 9V5.5zM.86 5.387A2.5 2.5 0 1 1 4.387 1.86 8.035 8.035 0 0 0 .86 5.387zM11.613 1.86a2.5 2.5 0 1 1 3.527 3.527 8.035 8.035 0 0 0-3.527-3.527z"/>
</svg><p style="margin-top:-15px;">&nbsp; Giờ làm việc:7h30-19h</p>
<hr>
<b>ROOM 3:</b><br>
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" style="float:left; margin-top:8px;" fill="currentColor" class="bi bi-geo-alt-fill" viewBox="0 0 16 16">
        <path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10zm0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6z"/>
        </svg><p> &nbsp; Địa chỉ: Hẻm 142, Phường 28, Bình Thạnh, TP HCM.</p>
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" style="float:left; margin-top:-5px;" fill="currentColor" class="bi bi-telephone-fill" viewBox="0 0 16 16">
  <path fill-rule="evenodd" d="M1.885.511a1.745 1.745 0 0 1 2.61.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.678.678 0 0 0 .178.643l2.457 2.457a.678.678 0 0 0 .644.178l2.189-.547a1.745 1.745 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.634 18.634 0 0 1-7.01-4.42 18.634 18.634 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877L1.885.511z"/>
</svg><p style="margin-top:-12px;"> &nbsp; Số điện thoại: <a href="tel:0357805837">0315751649</a></p>
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" style="float:left; margin-top:-5px;" fill="currentColor" class="bi bi-alarm-fill" viewBox="0 0 16 16">
...
<footer>
      ...
      <div class="col-left" style="width:500px; height:100%; float:left; ">
        ...
        <div class="congty" style="margin-top:20px;">
                  <h5 style="font-family: 'Oswald'; border-bottom: 1px solid ;">SHOP ĐỒNG HỒ THỜI TRANG CHÍNH HÃNG</h5>
      ...
      <div class="col-center" style="float:left; width:400px; height:60%; margin-top: 20px; margin-left:20px;">
        <h5 style="font-family: 'Oswald'; text-align:center; border-bottom: 1px solid ;">CHI NHÁNH ĐÀ NẴNG</h5>
...
<p>Giờ làm việc:8h-19h</p>
        ...
        <h5 style="font-family: 'Oswald'; text-align:center; border-bottom: 1px solid ;">CHI NHÁNH HCM</h5>
        <svg xmlns="http://www.w3.org/2000/svg" width="50" height="16" style="float:left;" fill="currentColor" class="bi bi-geo-alt-fill" viewBox="0 0 16 16">
                  <path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10zm0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6z"/>
        </svg>
