    ...
    <header>
        ...
        <nav class="navbar navbar-light bg-light" id="search" >
            <form class="form-inline">
              <input style="width:350px;" class="form-control mr-sm-2" name="search" type="search" placeholder="Bạn muốn tìm gì?" aria-label="Search" required>
...
<?php if (!isset($_GET['search'])) {
  ...
  <p style="background-color:	#EEE0E5;">🚴Trang chủ  » cửa hàng 1</p>

      <div class="sanphamnbanchay" Style="height:auto; margin-left:20px;" >
        <?php 
    ...
    box-shadow:  0 0 7px #000000; ">
      ...
      <div class="trangsanpham" style="text-align:center; ">
      <div class="btn-group" style="margin-top: 10px;">
    <a href="CUAHANG.php" class="btn btn-danger">1</a>
    <a href="CUAHANG2.php" class="btn btn-danger">2</a>
    <a href="CUAHANG3.php" class="btn btn-danger">3</a>
  
</div>
      </div>
      
        
      <div class="hangsanpham" style=" margin-top:50px;margin-bottom:20px;">
        <div class="h2">
