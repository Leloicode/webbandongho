...
<div style="font-size:30px;font-weight:bold">Xin chào <?php  echo $ten;?></div>
<p>Cảm ơn bạn đã ghé thăm cửa hàng <br>Chúc bạn một ngày mới vui vẻ và tràn đầy hạnh phúc!</p>
</div>
</div>
<?php
}
?>
    ...
    <header>
        ...
        <nav class="navbar navbar-light bg-light" id="search">
            <form class="form-inline">
              <input style="width:350px;" class="form-control mr-sm-2" type="search" name="search" placeholder="Bạn muốn tìm gì?" aria-label="Search" required>
  ...
  <div class="container" style="margin:0 auto; height:auto;">
      ...
      <div class="sanphamnbanchay" Style="height:auto;" >
        <?php 
